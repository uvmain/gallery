...
<template>
  <div>
    <div>
      ...
      <img :src="albumThumbnailAddress" onerror="this.onerror=null;this.src='/default-image.jpg';" class="w-full border-4 border-white border-solid object-cover lg:size-60 dark:border-neutral-500" @click="emits('navigate', album.Slug)" />
